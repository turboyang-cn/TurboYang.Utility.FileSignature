...
{
    public class Docx : Signature
    {
        public Docx()
            : base(".docx", "Microsoft Word Document", "application/vnd.openxmlformats-officedocument.wordprocessingml.document", new OfficeOpenXmlMatcher(
